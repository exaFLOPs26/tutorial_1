...
from isaaclab_tasks.manager_based.anubis_fixed.cabinet.cabinet_env_cfg import (  # isort: skip
    ...
    def __post_init__(self):
        ...
        self.scene.ee_R_frame = FrameTransformerCfg(
            ...
            visualizer_cfg=FRAME_MARKER_SMALL_CFG.replace(
                prim_path="/Visuals/RightEndEffectorFrameTransformer_R"
            ),
            target_frames=[
        ...
        self.scene.ee_L_frame = FrameTransformerCfg(
            ...
            debug_vis=False,
            visualizer_cfg=FRAME_MARKER_SMALL_CFG.replace(
                prim_path="/Visuals/LeftEndEffectorFrameTransformer_L"
            ),
            target_frames=[
                FrameTransformerCfg.FrameCfg(
